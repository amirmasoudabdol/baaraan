...
namespace baaraan {
    ...
    public:
        ...
        explicit truncated_normal_distribution(result_type mean = 0, result_type stddev = 1, result_type min = -3,
                                               result_type max = 3)
        ...
        bool operator==(const truncated_normal_distribution &x,
                        const truncated_normal_distribution &y) { return x.p_ == y.p_; }

        friend
        bool operator!=(const truncated_normal_distribution &x,
                        const truncated_normal_distribution &y) { return !(x == y); }
